 ...
 * 
 * @since 1.0.0
 * The initial version is a copy of how the Make theme does it
 * We do plan to enhance it in future with our own code
 * 
 */
/**
...
function cb_get_google_fonts() {
	 ...
	 */
	return apply_filters( 'cb_get_google_fonts', array(
		'ABeeZee' => array(
			'label' => 'ABeeZee',
			'variants' => array(
				'italic',
