...
/**
 * 
 * @original "make" from theme foundry
 * Modified for SocialPortal by 
 */

if ( class_exists( 'WP_Customize_Image_Control' ) ) :
/**
 * Class CB_Customize_Image_Control
 *
 * Extend WP_Customize_Image_Control allowing access to uploads made within the same context.
 *
 * @since 1.0.0.
 */
class CB_Customize_Image_Control extends WP_Customize_Image_Control {
	/**
