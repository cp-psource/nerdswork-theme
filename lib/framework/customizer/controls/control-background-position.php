<?php
/**
 * Original code ThemeFoundry's Make<https://thethemefoundry.com/wordpress-themes/make/>
 * Modified by Brajesh Singh for WMS N@W.com
 * 
 */

if ( class_exists( 'WP_Customize_Control' )  ) :
/**
 * Class CB_Customize_Background_Position_Control
 *
 * Specialized radio control for choosing background image positioning.
 *
 * @since 1.0.0.
 */
class CB_Customize_Background_Position_Control extends WP_Customize_Control {
