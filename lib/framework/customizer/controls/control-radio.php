...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'CB_Customize_Radio_Control' ) ) :
/**
 * Class CB_Customize_Radio_Control
 *
 ...
 * @since 1.5.0.
 */
class CB_Customize_Radio_Control extends WP_Customize_Control {
	public $type = 'radio';
	public $mode = 'radio';
