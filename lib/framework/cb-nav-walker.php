...
/**
 * WMS N@W Theme TreeView nav walker, based on Bootstrap Nav walker
 * Enables Treeview menu for the community builder theme
 * 
 */

class CB_TreeView_Navwalker extends Walker_Nav_Menu {
	...
	public function start_lvl( &$output, $depth = 0, $args = array() ) {
		...
		$output .= "\n$indent<ul role='menu' class='treeview-menu'>\n";
	}
	...
	public static function fallback( $args ) {
		...
		if ( current_user_can( 'manage_options' ) ) {
			...
			$fb_output .= '>';
			$fb_output .= '<li><a href="' . admin_url( 'nav-menus.php' ) . '">'. __( 'Add a menu', 'social-portal') . '</a></li>';
			$fb_output .= '</ul>';
