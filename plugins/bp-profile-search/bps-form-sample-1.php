...
<?php
	...
	echo "<form action='$action' method='$F->method' id='$form_id' class='standard-form bp-profile-search-form'>\n";
	...
	foreach ($F->fields as $f)
	{
		...
		case 'radio':
			...
			echo "</div>\n";
			echo "<a class='clear-value' href='javascript:clear(\"$f->code\");'>". __( 'Leeren', 'social-portal' ). "</a>\n";
			echo "</div>\n";
			break;
		...
		default:
			echo "<p>" . sprintf( __( "BP-Profilsuche: Du kannst den Filtertyp <em>%s</em> nicht anzeigen.", 'social-portal' ), $f->display ) . "</p>\n";
	...
	echo "<input type='submit' value='". __( 'Suche', 'social-portal' ) . "'>\n";
	echo "</div>\n";
