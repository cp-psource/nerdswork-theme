		...
		<?php while ( bp_message_threads() ) : bp_message_thread(); ?>
			<tr id="notice-<?php bp_message_notice_id(); ?>" class="<?php bp_message_css_class(); ?>">
				...
				<td width="21%">
					...
					<span class="activity"><?php _e( 'Sent:', 'social-portal' ); ?> <?php bp_message_notice_post_date(); ?></span>
				</td>
				...
				<td width="10%">
					...
					<a class="button" href="<?php bp_message_notice_delete_link(); ?>" class="confirm" title="<?php esc_attr_e( "Delete Message", "social-portal" ); ?>">x</a>
				</td>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php _e( 'Sorry, no notices were found.', 'social-portal' ); ?></p>
	</div>
