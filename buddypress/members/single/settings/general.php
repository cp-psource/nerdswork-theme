...
<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/general'; ?>" method="post" class="standard-form form-stacked" id="settings-form">
	...
	<div class="form-fields">
		<label for="email"><?php _e( 'Konto-E-Mail', 'social-portal' ); ?></label>
	...
	<fieldset>
		...
		<div class="form-fields">
			<label for="pass2"><?php _e( 'Wiederhole das neue Passwort', 'social-portal' ); ?></label>
