...
<form action="<?php echo trailingslashit( bp_displayed_user_domain() . bp_get_settings_slug() . '/profile' ); ?>" method="post" class="standard-form form-stacked" id="settings-form">
				...
				<table class="profile-settings" id="xprofile-settings-<?php bp_the_profile_group_slug(); ?>">
					...
					<thead>
						<tr>
							...
							<th class="title"><?php _e( 'Sichtbarkeit', 'social-portal' ); ?></th>
						</tr>
					</thead>
	...
	<div class="submit">
		<input id="submit" type="submit" name="xprofile-settings-submit" value="<?php esc_attr_e( 'Einstellungen speichern', 'social-portal' ); ?>" class="auto" />
	</div>
