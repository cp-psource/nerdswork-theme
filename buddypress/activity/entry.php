	...
	<div class="activity-content">
		...
		<div class="activity-meta">
			...
			<?php if ( bp_get_activity_type() == 'activity_comment' ) : ?>
				<a href="<?php bp_activity_thread_permalink(); ?>" class="button view bp-secondary-action" title="<?php esc_attr_e( 'Zeige das Gespräch', 'social-portal' ); ?>"><?php _e( 'Zeige das Gespräch', 'social-portal' ); ?></a>
			<?php endif; ?>

			<?php if ( is_user_logged_in() ) : ?>

				<?php if ( bp_activity_can_comment() ) : ?>
					<a href="<?php bp_activity_comment_link(); ?>" class="button acomment-reply bp-primary-action" id="acomment-comment-<?php bp_activity_id(); ?>"><?php printf( __( 'Kommentar <span>%s</span>', 'social-portal' ), bp_activity_get_comment_count() ); ?></a>
				<?php endif; ?>
			...
			<?php if ( is_user_logged_in() && bp_activity_can_comment() ) : ?>
				...
				<form action="<?php bp_activity_comment_form_action(); ?>" method="post" id="ac-form-<?php bp_activity_id(); ?>" class="ac-form"<?php bp_activity_comment_form_nojs_display(); ?>>
					...
					<div class="ac-reply-content">
						...
						<input type="submit" name="ac_form_submit" value="<?php esc_attr_e( 'Veröffentlichen', 'social-portal' ); ?>" /> &nbsp;
