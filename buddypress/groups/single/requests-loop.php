		...
		<?php while ( bp_group_membership_requests() ) : bp_group_the_membership_request(); ?>
			...
			<li>
				...
				<div class="action">
					...
					<?php bp_button( array( 'id' => 'group_membership_accept', 'component' => 'groups', 'wrapper_class' => 'accept', 'link_href' => bp_get_group_request_accept_link(), 'link_title' => __( 'Akzeptieren', 'social-portal' ), 'link_text' => __( 'Akzeptieren', 'social-portal' ) ) ); ?>

					<?php bp_button( array( 'id' => 'group_membership_reject', 'component' => 'groups', 'wrapper_class' => 'reject', 'link_href' => bp_get_group_request_reject_link(), 'link_title' => __( 'Ablehnen', 'social-portal' ), 'link_text' => __( 'Ablehnen', 'social-portal' ) ) ); ?>
